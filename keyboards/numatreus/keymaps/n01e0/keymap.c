...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH ,
        KC_ESC, KC_LSFT, KC_LGUI,  MO(_LW), KC_LCTL, KC_TAB, KC_ENT, KC_SPC,  MO(_RS), KC_RALT, KC_QUOT, KC_BSPC
  ),
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    KC_VOLD,   KC_VOLU, KC_NO,   KC_NO,   RESET,                     KC_EQL,   KC_F1,   KC_F2,   KC_UP,   KC_BSLS ,
    KC_ESC,   KC_LSFT, KC_LGUI, KC_LSFT, KC_LCTL, KC_TAB, KC_ENT, KC_SPC,  TO(_QW), KC_LEFT, KC_DOWN, KC_RGHT )
