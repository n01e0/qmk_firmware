...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_LSFT, KC_ESC, KC_LGUI, KC_LCTL,  MO(_LW), KC_SPC, KC_ENT,  MO(_RS), KC_SPC, KC_RALT, KC_QUOT, KC_BSPC
  ),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_LW), KC_INS,  KC_LGUI, KC_LCTL, KC_LCTL, KC_TAB, KC_ENT, KC_SPC,  KC_TRNS, KC_DOT, KC_EQL, KC_BSPC  ),
